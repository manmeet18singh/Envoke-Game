...
public class HailFactory : SpellFactoryBase
{
    ...
    public override bool CastSpell()
    {
        ...
        if (mCanCast)
        {
            Vector3 offset = new Vector3(mHit.point.x, mHit.point.y + 5.5f, mHit.point.z);
            HailController hail = Instantiate(mSpellPrefab, offset, Quaternion.identity).GetComponent<HailController>();
